                ...
                <div className="mainCon">
                    ...
                    <div className="formCom">
                        ...
                        <ReactQuill
                         ...
                         formats={formats}
                            className="textEdit"
                            value={mainForm.privacy}
                            onChange={(e) => handleOnChange(e, "privacy")}
                            placeholder="Enter privacy"
                            required
                        />
                        {error.privacy && <p className="errorText">{error.privacy}</p>}
                    </div>
                    ...
                    <div className="preview">
                        ...
                        <div
                            ...
                            dangerouslySetInnerHTML={{ __html: mainForm.privacy }}
                        />
                    </div>
