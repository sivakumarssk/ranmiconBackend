...
const Plans = () => {
    ...
    const fetchData = async () => {
        try {
            const plansResponse = await axios.get('https://admin.emdcconference.com/api/getPlans');
            const participationResponse = await axios.get('https://admin.emdcconference.com/api/getparticipation');
    ...
    const handleCreateOrUpdatePlan = async () => {
        try {
            ...
            if (isEditing) {
                ...
                // Create Plan
                const response = await axios.post('https://admin.emdcconference.com/api/createPlan', {
                    name: newPlan.name,
                    startDate: newPlan.startDate,
                    endDate: newPlan.endDate,
    ...
    const handleDeletePlan = async (planId) => {
        try {
            await axios.delete(`https://admin.emdcconference.com/api/deletePlan/${planId}`);
    ...
    const handleCreateParticipationType = async () => {
        try {
            const response = await axios.post('https://admin.emdcconference.com/api/participationtypes', {
    ...
    const handleDeleteParticipationType = async (id) => {
        try {
            await axios.delete(`https://admin.emdcconference.com/api/deleteparticipation/${id}`);
